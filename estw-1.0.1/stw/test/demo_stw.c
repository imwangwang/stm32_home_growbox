...
#include "../include/safe_types.h"
#include "../include/stw_system_timer.h"
 ...
 */
static int
radio_parse_user_options (int argc, char *argv[])
{
...
int main (int argc, char **argv)
{
    ...
    radio_parse_user_options(argc, argv);  
