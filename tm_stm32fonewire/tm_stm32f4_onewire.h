...
/* Pin settings */
#define ONEWIRE_LOW(structure)			(structure)->GPIOx->BRR = (structure)->GPIO_Pin
#define ONEWIRE_HIGH(structure)			(structure)->GPIOx->BSRR = (structure)->GPIO_Pin;
#define ONEWIRE_INPUT(structure)		OGIS.GPIO_Mode = GPIO_Mode_IPU; OGIS.GPIO_Pin = (structure)->GPIO_Pin; GPIO_Init(structure->GPIOx, (GPIO_InitTypeDef *)&OGIS);
#define ONEWIRE_OUTPUT(structure)		OGIS.GPIO_Mode = GPIO_Mode_Out_PP; OGIS.GPIO_Pin = (structure)->GPIO_Pin; GPIO_Init(structure->GPIOx, (GPIO_InitTypeDef *)&OGIS);
