...
#define RTC_STATUS_REG      			BKP_DR1  // Status Register
 ...
 */
extern TM_RTC_Result_t TM_RTC_SetDateTime(TM_RTC_t* data);
 ...
 * 		Member of struct TM_RTC_Format_t
 */
extern void TM_RTC_GetDateTime(TM_RTC_t* data);
 ...
 */
extern void TM_RTC_SetAlarm(TM_RTC_Alarm_t Alarm, TM_RTC_AlarmTime_t* AlarmTime);
...
extern void GregorianDay(TM_RTC_t *tm);
extern uint32_t mktimev(TM_RTC_t *tm);
extern void to_tm(uint32_t tim, TM_RTC_t *tm);
