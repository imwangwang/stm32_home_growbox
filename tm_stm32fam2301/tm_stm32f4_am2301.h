...
#ifndef AM2301_PIN
#define AM2301_RCC				RCC_APB2Periph_GPIOD
#define AM2301_PORT				GPIOD
#define AM2301_PIN				GPIO_Pin_1
#endif

/* Pin settings */
#define AM2301_PIN_LOW			AM2301_PORT->BRR = AM2301_PIN
#define AM2301_PIN_HIGH			AM2301_PORT->BSRR = AM2301_PIN
#define AM2301_PIN_IN			AM2301_GPIO_InitStruct.GPIO_Mode = GPIO_Mode_IPU; GPIO_Init(AM2301_PORT, &AM2301_GPIO_InitStruct)
#define AM2301_PIN_OUT			AM2301_GPIO_InitStruct.GPIO_Mode = GPIO_Mode_Out_PP; GPIO_Init(AM2301_PORT, &AM2301_GPIO_InitStruct)
